...
export const en: Copy = {
  ...
  charter: {
    ...
    photo: {
      alt: "Young avocado trees in rows across a green field under a cloudy sky.",
      caption: "Young avocado trees",
    },
    visionTitle: "Vision",
    vision:
  ...
  method: {
    ...
    photos: [
      { alt: "Nursery aisle between rows of bagged avocado seedlings.", caption: "Nursery" },
      { alt: "Staked avocado seedlings in bags, lined up in the nursery.", caption: "Nursery seedlings" },
      { alt: "Dirt track between two rows of mature avocado trees.", caption: "Mature orchard" },
    ],
    closing:
